        ...
        <View style={styles.containerProgressbar}>
            <ScrollView>
                ...
                <View style={styles.containerLogin}>
                    ...
                    <Text style={styles.DiaSemana}>Em qual dia da semana você quer receber a sua cesta?</Text>
                    <View  >
                        <RadioButton.Group onValueChange={newValue => setValueDia(newValue)} value={valueDia}>
                            <View style={styles.RadioGroup}>
                                <View style={styles.ViewRadioGroup}>
                                    ...
                                    <Text>Primeira entrega em</Text>
                                </View>
                                <View style={styles.ViewRadioGroup}>
                                    <Text>Terça-feira</Text>
                                    <RadioButton value="Terça-feira" />
                                    <Text>Primeira entrega em</Text>
                                </View>
                                <View style={styles.ViewRadioGroup}>
                                    <Text>Quarta-feira</Text>
                                    <RadioButton style={{ justifyContent: 'center' }} value="Quarta-feira" />
                                    <Text>Primeira entrega em</Text>
                                </View>
